...
plot_homeless_gaps <- ggplot() + 
  ...
  new_scale_color() +
  geom_line(data = homelesssbyrace, aes(x = rate_region, y = year, group = year), size = 0.8, color = "#2F3136") +
  geom_point(data = homelesssbyrace, aes(x = rate_region, y = year, group = year, color=race), position = 'identity', size = 7) +
  scale_color_manual(values = c("#E0004E", "#58a2ee","#860967", "#a942be", "#0cc0aa", "#5C6068")) +
...
ggplot() + 
  ...
  geom_text_repel(data = oss_race_only, aes(x = Year, y = meanpercsus, color = Race, label = label), size = 3.5, fontface = "bold", nudge_x = .3, show.legend = FALSE, min.segment.length = Inf) +
  scale_color_manual(values = c("#E0004E", "#58a2ee","#860967", "#a942be", "#0cc0aa")) + 
  new_scale_color() +
